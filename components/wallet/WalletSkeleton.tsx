...
export function WalletSkeleton() {
  return (
    <div className="relative flex min-h-dvh sm:min-h-233 flex-col justify-between overflow-hidden bg-[#662AB2]">
      ...
      <div className="w-216 h-215 -left-54 top-65 absolute bg-white rounded-full z-0 shadow-lg pointer-events-none" />
